...
"""Q9: How would you modify this code to output the full range 1 to 10?"""



"""Q10: How would you rewrite the code to include only the even numbers from 1 to 10?"""

"""Q11: Create the list `numbers` with the following values: `[[0, 1], [2, 3], [4, 5]]`. Write code  that accomplishes the following steps or tasks."""
